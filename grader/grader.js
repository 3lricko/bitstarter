...
var processPage = function(result, response){
...
var getUrl = function(url){
    ...
    rest.get(url).on('complete',processPage);
};
...
var validateFile = function(htmlfile, checksfile){
...
if(require.main == module) {
	...
	.option('-u, --url <ulr>', 'Url to index.html')
	.parse(process.argv);
    
    if(program.url == null){
	validateFile(program.file, program.checks);
    }else{
